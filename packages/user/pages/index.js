    ...
    <div className={classes.bigContainer}>
      ...
      <div className={classes.Header}>
        ...
        >
          ...
          <Grid item xs={12} lg={3} sm={6} md={3}>
            <Paper elevation={0} style={{textAlign:'center'}}><CardWithoutContent 
            src='https://i0.wp.com/northforker.com/files/2021/02/8E708912-4A5A-4183-B83D-5D6ED1F42496.jpeg?resize=640%2C633&ssl=1'/></Paper>
          </Grid>
          <Grid item xs={12} lg={3} sm={6} md={3}>
            <Paper elevation={0} style={{textAlign:'center'}}><CardWithoutContent 
            src='https://neatplaces.co.nz/media/thumbs/uploads/places/place/dead_souls_bookshop/Dead_Souls_Bookshop_Dunedin_9.jpg.650x425_q80_crop-smart_upscale.jpg'/></Paper>
          </Grid>
          <Grid item xs={12} lg={3} sm={6} md={3}>
            <Paper elevation={0} style={{textAlign:'center'}}><CardWithoutContent 
            src='https://i.pinimg.com/736x/58/f2/f6/58f2f61e1be6b900a5b0ceb32c48a417.jpg'/></Paper>
          </Grid>
        </Grid>
      </div>
      <div>
